...
public class ToastnotificationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        IntentFilter mintentfilter = new IntentFilter("com.example.shentanli.accessibility_apk.toast");
        mintentfilter.addAction("com.example.shentanli.accessibility_apk.toast");
    ...
    private final BroadcastReceiver toastCatcherReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i("shentanli--", intent.getStringExtra("com.example.shentanli.accessibility_apk.toast"));
        }
    };
